...
const ContactUs = () => {
  return (
    <>
    <div className='relative overflow-x-hidden dark:bg-gray-900 dark:text-gray-50'>
      <div className=''>
        <Navbar />
      </div>
      <section class="h-screen text-gray-800 dark:text-gray-600 body-font relative padding">
        <div class="container px-5 pt-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-12">
            <h1 class="sm:text-5xl text-2xl font-semibold title-font mb-4 text-black dark:text-white">
              Contact Us
            </h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-gray-600 text-base font-semibold">
            ...
            <div class="flex flex-wrap -m-2">
              <div class="p-2 w-1/2">
                <div class="relative">
                  <label
                    for="name"
                    class="leading-7 text-sm text-black dark:text-white font-semibold"
                  >
                    Name
                  </label>
                  <input
              ...
              <div class="p-2 w-full">
                <button class="flex mx-auto bg-black text-white dark:text-black dark:bg-white border-0 py-2 px-8 rounded text-lg">
                  Send
                </button>
              </div>
              <div class="p-2 w-full pt-8 mt-8 border-t border-black dark:border-gray-200 text-center">
